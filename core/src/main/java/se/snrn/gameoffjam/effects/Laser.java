package se.snrn.gameoffjam.effects;
...
public class Laser {
    ...
    public Laser() {
        ...
        Texture texLaserS1 = new Texture(Gdx.files.internal("images/laser/beamstart1.png"));
        Texture texLaserS2 = new Texture(Gdx.files.internal("images/laser/beamstart2.png"));
        Texture texLaserM1 = new Texture(Gdx.files.internal("images/laser/beammid1.png"));
        Texture texLaserM2 = new Texture(Gdx.files.internal("images/laser/beammid2.png"));
        Texture texLaserE1 = new Texture(Gdx.files.internal("images/laser/beamend1.png"));
        Texture texLaserE2 = new Texture(Gdx.files.internal("images/laser/beamend2.png"));
